...
require('lazy').setup({
  ...
  -- Local plugins
  { dir = '/home/andrew/projects/nvim/plugins/hermes.nvim' },
...
function FindNeovimFiles ()
  return require('telescope.builtin').find_files({ cwd = '~/.config/nvim' })
end
vim.keymap.set('n', '<leader>en', FindNeovimFiles, { desc = '[E]dit [N]eovim' })
